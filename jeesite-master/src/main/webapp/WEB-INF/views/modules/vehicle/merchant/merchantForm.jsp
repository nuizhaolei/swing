...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/vehicle/merchant/merchant/">商家列表</a></li>
		<li class="active"><a href="${ctx}/vehicle/merchant/merchant/form?id=${merchant.id}">商家${not empty merchant.id?'修改':'添加'}</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="merchant" action="${ctx}/vehicle/merchant/merchant/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
